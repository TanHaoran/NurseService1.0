...
namespace Aersysm.Persistence {
    ...
    public partial class UserrelrecordSqlMapDao : BaseSqlMapDao {
        ...
        /// 得到列表（分页）
        /// </summary>
        public IList<Userrelrecord> GetUserrelrecordListPage(int pageNumber, int pageSize) {
            Dictionary<string, int> dic = new Dictionary<string, int>();
            dic.Add("skip", (pageNumber - 1) * 10);
            dic.Add("count", pageSize);
            return ExecuteQueryForList<Userrelrecord>("SelectuserrelrecordPage", dic);
        }

        public int GetCount() {
            return ExecuteQueryForObject<int>("SelectCount", null);
        }
